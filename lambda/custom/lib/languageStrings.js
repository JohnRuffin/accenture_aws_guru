const languageStrings = {
  en: {
    translation: {
      FIRST_WELCOME: `Hello. Welcome to the Accenture AWS GURU Alexa skill. Your daily goal 
	  is to go through 3 rounds of questions, correctly answering 3 questions in a row in each round,  
	  Completing the top round, the Accenture AWS GURU round, will immortalize you on our 
	  Leaderboard tally.  The more you earn daily guru status, the higher your overall Leaderboard tally.  
	  It won't be easy, pilgrim. `,

      RETURN_WELCOME: [
        "Welcome back. ",
        "You again, you enjoy torturing yourself I see? ",
        "Back for another good ole college try eh?"
      ],

      GAME_INTRO: [
        `No need to wait. Let's get started. `,
        `Lets dig in Accenture warrior. You better be ready. `
      ],

      AISLES: ["VEGETABLES", "FRUITS", "MEATS"],
      ...
      LEVEL_1: [
        // always add one item in the trolley
        "Let us start off easy. "
      ],

      LEVEL_2: [
        // always keep the second item in the trolley
        "Now we will make things a little harder. "
      ],

      LEVEL_3: [
        // always keep two items in the trolley
        "Ok, now unto the hard stuff."
      ],

      SCORE_UPDATE: ["You have %s points. "],
